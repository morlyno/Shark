...
namespace Sandbox
{
	public class EmptyScript
	{
		...
		protected virtual void OnUpdate(float ts) { Log.Info("EmptyScript.OnUpdate"); }
		protected virtual void OnPhysicsUpdate(float fixedTimeStep) { Log.Info("EmptyScript.OnPhyisicsUpdate"); }
