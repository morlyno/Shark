...
namespace Shark::UI {
   ...
   /// Controls ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	bool Control(std::string_view label, float& val,     float resetVal,            float min,            float max,            float speed,            std::string_view fmt, ControlType type) { return ControlScalar(label, ImGuiDataType_Float, Utility::ValuePtr(val), 1, Utility::ValuePtr(resetVal), Utility::ValuePtr(speed), Utility::ValuePtr(min), Utility::ValuePtr(max), fmt, type); }
	...
	bool Control(std::string_view label, int& val,        int resetVal,               int min,               int max,               int speed,               std::string_view fmt, ControlType type) { return ControlScalar(label, ImGuiDataType_S32, Utility::ValuePtr(val), 1, Utility::ValuePtr(resetVal), Utility::ValuePtr(speed), Utility::ValuePtr(min), Utility::ValuePtr(max), fmt, type); }
	...
	bool Control(std::string_view label, uint32_t& val,   uint32_t resetVal,          uint32_t min,          uint32_t max,          uint32_t speed,          std::string_view fmt, ControlType type) { return ControlScalar(label, ImGuiDataType_U32, Utility::ValuePtr(val), 1, Utility::ValuePtr(resetVal), Utility::ValuePtr(speed), Utility::ValuePtr(min), Utility::ValuePtr(max), fmt, type); }
