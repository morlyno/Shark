...
namespace Shark {
	...
	public:
		...
		static inline Ref<IndexBuffer> CreateIndexBuffer(const Buffer& data, bool dynamic) { return s_RendererAPI->CreateIndexBuffer(data, dynamic); }
		...
		static inline Ref<SwapChain> CreateSwapChain(const SwapChainSpecifications& specs) { return s_RendererAPI->CreateSwapChain(specs); }
	private:
