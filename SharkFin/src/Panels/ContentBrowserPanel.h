...
#include "Panels/ContentBrowserItem.h"
...
namespace Shark {
	...
	private:
		...
		Ref<DirectoryInfo> GetDirectory(Ref<ContentBrowserItem> item);
	...
	private:
		Ref<ContentBrowserItem> CreateDirectory(const std::string& name);
